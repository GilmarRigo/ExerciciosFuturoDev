...
public class CadastroServlet extends HttpServlet {
    ...
    resp.setContentType("text/html");
        ...
        */
        ...
        if(media >= 7){
            writer.println("<h2>O aluno(a) " + aluno +  " foi Aprovado!</h2>");
        } else if ((media >= 6) && (media <= 6.9)) {
            writer.println("<h2>O aluno(a) " + aluno + " está em Recuperação!</h2>");
        } else if (media < 6) {
            writer.println("<h2>O aluno(a) " + aluno + " está Reprovado!</h2>");
